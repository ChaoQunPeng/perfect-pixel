...
export const Events = {
  ...
  UPDATE_IMAGE_WINDOW_OPACITY: 'update-image-window-opacity',
  UPDATE_IMAGE_WINDOW_SIZE: 'update-image-window-size',
  UPDATE_IMAGE_WINDOW_POSITION: 'update-image-window-position',
  GET_IMAGE_WINDOW_POSITION: 'get-image-window-position',
